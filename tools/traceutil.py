'''traceutil - A simple UDP trace client and server

Created to help with IronPython web app development as I missed not having
CPythons excellent win32traceutil.

'''
import sys, socket
#-----------------------------------------------------------------------------
# Following code from creosote.py - lightweight message passing with datagrams
# by Jeff Bauer
# Have included the code rather than importing it, as the original source url
# is broken
BUFSIZE = 1024
PORT = 7739
